...
def start_game(rules: str, questions: list, correct_answers: list):
    ...
    Если пользователь правильно отвечает на все 3 вопроса
     - выводит сообщение об успешном прохождении.
    Если дается неверный ответ
     - выводит сообщение об этом и игра заканчивается.
    """
